...
¡Gracias por tu interés en contribuir a **Laboratorio ELK Stack**! Esta guía describe el flujo de trabajo, los estándares de código y el proceso de Pull Requests.
...
- Sigue las convenciones idiomáticas de JavaScript (Node.js) (p. ej. `camelCase`/`snake_case`/`PascalCase` según corresponda).
